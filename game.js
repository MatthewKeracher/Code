...
function fillMap(){
  ...
  for (let i = 0; i < data.length; i++) {
        ...
        //console.log(location)
          ...
          //PAINTS THE SQUARES
         gridCTX.fillRect(data[i].x * tileSize, data[i].y * tileSize, tileSize, tileSize)
         
          if(data[i].x == rx && data[i].y == ry){
